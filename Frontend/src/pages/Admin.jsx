...
const Admin = () => {
  ...
  return (
    <div className='mb-4 px-8 w-full h-screen relative'>
      ...
      <section className={`grid grid-cols-2 gap-8 gap-x-12 p-8 h-[85%] z-0 overflow-y-auto bg-white border rounded-xl transition-all duration-700 ${showCreateAdmin ? 'blur-sm bg-gray-300 opacity-60' : ''} `}>
